  ...
  return (
    <div className="group flex items-center rounded-lg border border-zinc-200 bg-white transition hover:border-zinc-300 hover:shadow-sm">
        ...
        <div className="flex items-center gap-4">
          <div className="flex-1 min-w-0">
            <div className="flex items-baseline gap-2">
              ...
              {w.layer && (
                <span className="text-[10px] text-zinc-500">L{w.layer}</span>
              )}
            </div>
      ...
      <button
        ...
        title="从观察列表移除"
        aria-label="从观察列表移除"
        className="shrink-0 mr-2 px-3 py-2 text-zinc-300 hover:text-rose-500 hover:bg-rose-50 rounded transition"
      >
        ✕
      </button>
    </div>
