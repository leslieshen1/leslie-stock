...
export default function RootLayout({
 ...
 <div className="mx-auto max-w-[1480px] px-6 py-9 text-center text-[11px] leading-relaxed text-faint">
            <p className="font-display text-[15px] italic tracking-wide text-muted">Not a Stock Guru</p>
 <p className="mt-1.5 text-[12px] text-muted">你不是股神,但股神陪你一起看股票</p>
 ...
 所有内容为信息整理与个人研究记录,<strong className="text-muted">非投资建议</strong>,不构成对任何证券、平台或交易所的要约或背书。
 股票、加密货币、代币化资产均涉及重大风险,可能损失全部本金。<strong className="text-muted">风险请自行分辨与承担。</strong>
