...
export const COMPANIES: Company[] = [
  ...
  c("688008", "澜起科技",         "L2", "内存接口 · DDR5 RCD", "CN", 21, 4, 85, 82, 75, 82),
  c("3037",   "欣兴 Unimicron",   "L2", "ABF 载板",  "TW", 9,  4, 78, 72, 66, 70),
  ...
  c("300394", "天孚通信",         "L4", "CPO 光引擎", "CN", 10,  4, 88, 85, 78, 85),
  ...
  c("COHR",   "Coherent",         "L4", "CPO 硅光子", "US", 18,  4, 78, 75, 70, 70),
  ...
  c("002463", "沪电股份",         "L4", "PCB · 高速",   "CN", 11, 4, 86, 84, 78, 82),
  c("300476", "胜宏科技",         "L4", "PCB · GPU板",  "CN", 11, 4, 90, 90, 82, 88),
  c("600183", "生益科技",         "L4", "覆铜板 CCL",   "CN", 8,  4, 82, 78, 72, 78),
  c("LITE",   "Lumentum",         "L4", "光模块 · CPO 硅光子", "US", 8, 4, 82, 80, 74, 76),
  c("2301",   "光宝科技 Lite-On", "L4", "电源 · 光模块","TW", 9,  3, 72, 70, 66, 64),
  c("300602", "飞荣达",           "L4", "液冷 · 散热",  "CN", 4,  3, 84, 85, 80, 75),
  c("2308",   "台达电 Delta",     "L4", "电源 · HVDC",  "TW", 38, 5, 80, 75, 68, 78),
  c("002851", "麦格米特",         "L4", "电源",         "CN", 6,  3, 80, 80, 74, 72),
